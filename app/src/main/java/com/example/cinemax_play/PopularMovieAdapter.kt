...
class PopularMovieAdapter(val context: Activity, var movieArrayList: List<Result>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.share.setOnClickListener {
            ...
            intent.putExtra(Intent.EXTRA_TEXT,"Hey, Checkout this cool movie ${currentItem.title} on Cinemax-Play")
            val chooser = Intent.createChooser(intent, "Share this movie using....")
